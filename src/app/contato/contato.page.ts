...
export class ContatoPage implements OnInit {
  ...
  async enviaEmail() {
    const serviceID = (environment as any).emailJS.serviceID;
    const templateID = (environment as any).emailJS.templateID;
    const userID = (environment as any).emailJS.userID;
